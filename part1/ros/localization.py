...
class Particle(object):
    ...
    def is_valid(self):
        ...
        return x_ok and y_ok and not_in_cylinder
    ...
    def ray_trace(self, angle):
        ...
        d = min(intersection_segment(-WALL_OFFSET, -WALL_OFFSET, -WALL_OFFSET, WALL_OFFSET),
                intersection_segment(
                    WALL_OFFSET, WALL_OFFSET, -WALL_OFFSET, WALL_OFFSET),
                intersection_segment(-WALL_OFFSET,
                                     WALL_OFFSET, -WALL_OFFSET, -WALL_OFFSET),
                intersection_segment(-WALL_OFFSET, WALL_OFFSET,
...
def run(args):
    ...
    particle_publisher = rospy.Publisher(
        '/particles', PointCloud, queue_size=1)
    laser = SimpleLaser()
    motion = Motion()
    ...
    while not rospy.is_shutdown():
        ...
        pose_history.append(np.concatenate(
            [groundtruth.pose, median_pose], axis=0))
